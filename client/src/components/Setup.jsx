...
const Setup = ({ onStart }) => {
  ...
  return (
    ...
    justify-center bg-linear-to-br from-gray-100 to-gray-200 px-4"
    >
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <motion.div
          ...
          className="relative bg-linear-to-br from-green-50 to-green-100 p-12 flex flex-col
        justify-center"
        >
                ...
                {skills.length > 0 && (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {skills.map((s,i)=>(
                      ...
                      text-green-700 px-3 py-1 rounded-full text-sm">{s}</span>
                    ))}
                  </div>
                  </div>
                )}
