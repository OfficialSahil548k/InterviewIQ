...
const Interview = ({ interviewData, onFinish }) => {
  ...
  useEffect(()=> {
    ...
    runIntro();
  },[isIntroPhase, selectedVoice, currentIndex]);
  ...
  return (
    <div
      className="bg-linear-to-br from-emerald-50 via-white 
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative">
          ...
          >
            <p className="text-xs sm text-gray-400 mb-2">
         ...
         {!feedback ? (
          <div className="flex items-center gap-4 mt-6">
            <motion.button
              onClick={toggleMic}
              whileTap={{ scale: 0.9 }}
              className="w-14 h-14 flex items-center justify-center rounded-full bg-black text-white shadow-lg"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-1 py-4 bg-linear-to-r from-emerald-600 to-teal-500
            ...
            className="mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm">
              ...
              <button className="w-full bg-gradient-to-r from-emerald-600 
