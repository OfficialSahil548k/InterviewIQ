...
const Report = ({ report }) => {
  ...
  return (
    <div
      className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4
    ...
    >
      ...
      >
        ...
        <button onClick={downloadPDF} className="bg-emerald-600 hover:bg-emerald-700 text-white px-2  
